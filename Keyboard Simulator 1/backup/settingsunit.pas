...
type
  ...
  TSettingsForm = class(TForm)
    ...
    procedure LettersIntervalBoxChange(Sender: TObject);
    procedure LettersIntervalBoxEditingDone(Sender: TObject);
    procedure LevelBoxChange(Sender: TObject);
    procedure NumLettersBoxChange(Sender: TObject);
...
procedure TSettingsForm.LettersIntervalBoxChange(Sender: TObject);
begin
...
procedure TSettingsForm.NumLettersBoxChange(Sender: TObject);
begin
end;
